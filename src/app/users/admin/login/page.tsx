  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-r from-[#27374D] to-[#526D82]">
      <div className="bg-[#9DB2BF] shadow-md rounded-lg p-8 w-full max-w-sm">
        <h2 className="text-3xl font-extrabold mb-4 text-center text-gray-800">Admin Log In</h2>
        <h3 className="text-xl font-extrabold mb-2 text-center text-gray-700">Are you an club member? Visit <span><Link href={'/users/club/login'}><u>clubs login</u></Link></span></h3>
